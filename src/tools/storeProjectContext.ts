...
export function createStoreProjectContextTool(db: DatabaseManager): Tool {
  return {
    ...
    description: `Store or update project information including repository URL, local directory, and metadata.
    
Examples:
- Store a new project: "Remember this new project 'my-app' with repository https://github.com/user/my-app"
- Update project status: "Update project 'my-app' status to completed"
- Add project location: "Project 'my-app' is located at ~/Development/my-app"`,
