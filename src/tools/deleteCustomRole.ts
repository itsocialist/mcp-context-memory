...
Note: 
- You can only delete custom roles, not the default roles (architect, developer, devops, qa, product)
- You can only delete roles you created on this system
- Existing context entries will keep their role association, but the role won't be active
- If this role is currently active for any project, you'll need to switch to another role`,
