...
You can override the template's ID by providing a custom role_id.

Example templates will be available in the project's examples/role-templates/ directory.`,
