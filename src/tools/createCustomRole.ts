...
export const createCustomRoleTool: Tool = {
  ...
  description: `Create a custom role with your own focus areas and preferences.

You can base it on an existing role (architect, developer, devops, qa, product) to inherit its configuration as a starting point.

Examples:
- Security Engineer: Based on architect, focuses on security and compliance
- Technical Writer: Based on developer, focuses on documentation
- Data Engineer: Based on developer, focuses on data pipelines
- Platform Engineer: Based on devops, focuses on platform tools

The role ID must be alphanumeric with dashes/underscores (e.g., "security-engineer").`,
